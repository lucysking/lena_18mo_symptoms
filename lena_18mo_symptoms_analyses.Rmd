...
lena_18mo_sym_int_numstress <- 
  lm(
    itsea_symptoms ~ 
      crisys_total_6mo_win * num_stress_total,
    data = lena_18mo_sym_df)
summary(lena_18mo_sym_int_numstress)
#ns

lena_18mo_sym_int_numstress_preg <- 
  lm(
    itsea_symptoms ~ 
      crisys_total_6mo_win * num_stress_preg,
    data = lena_18mo_sym_df)
summary(lena_18mo_sym_int_numstress_preg)
#ns

lena_18mo_sym_int_sumsev <- 
  lm(
    itsea_symptoms ~ 
      crisys_total_6mo_win * sum_sev,
    data = lena_18mo_sym_df)
summary(lena_18mo_sym_int_sumsev)
#ns

lena_18mo_sym_int_maxsev <- 
  lm(
    itsea_symptoms ~ 
      crisys_total_6mo_win * max_sev,
    data = lena_18mo_sym_df)
summary(lena_18mo_sym_int_maxsev)
#ns
