...
# ols_plot_diagnostics(lena_18mo_sym_int_awc) - not really sure why this isn't working
 ...
 #look at predicted vs. residual values (want them to be normally distributed in relation to each other)
 #this package should do all that
 #how much 
```
