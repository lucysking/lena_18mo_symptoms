...
##Fran file paths
#crisys_file <- "~/Desktop/lena_18mo_symptoms/Data/crisys_6mo_20190413.csv"
#q_18mo_file <- "~/Desktop/lena_18mo_symptoms/Data/q_18month_scores_20190413.csv"
#q_18mo_ages_file <- "~/Desktop/lena_18mo_symptoms/Data/q_18month_ages.csv"
#demographics_file <- "~/Desktop/lena_18mo_symptoms/Data/demographics_20190413.csv"
#lena_file <- "~/Desktop/lena_18mo_symptoms/Data/lena_cleaned_day1_20190413.csv"
#lena_follow_and_data_file <- "~/Desktop/lena_18mo_symptoms/Data/lena_followup_and_data_20190413.csv"
#baby_raceth_file <- "~/Desktop/lena_18mo_symptoms/Data/baby_race_ethnicity.csv"
#ibq_file <- "~/Desktop/lena_18mo_symptoms/Data/ibq_scored_20190413.csv"
...
```
# Demographics in only subset with complete data
...
lena_18mo_sym_df <-
  ...
  mutate(
    ...
    crisys_neg_median_split = if_else(
...
#differences among stressed vs. non-stressed groups by education, income_needs, daily rates, props, itsea_symptoms, itsea_competence
...
#Run main analyses (interactions) with crisys_total
...
lena_18mo_sym_int_awc <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win * awc_prop_centered,
...
lena_18mo_sym_int_ctc <- 
  lm(
    itsea_symptoms ~ 
      crisys_total_6mo_win * ctc_prop_centered,
    data = lena_18mo_sym_df
    )
...
lena_18mo_sym_int_cvc <- 
  lm(
    itsea_symptoms ~ 
      crisys_total_6mo_win * cvc_prop_centered,
    data = lena_18mo_sym_df
    )
summary(lena_18mo_sym_int_cvc)
#ns

lena_18mo_sym_int_awc_daily_rate <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win * awc_daily_rate,
    data = lena_18mo_sym_df 
  )
summary(lena_18mo_sym_int_awc_daily_rate)
#ns

lena_18mo_sym_int_ctc_daily_rate <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win * ctc_daily_rate,
    data = lena_18mo_sym_df 
  )
summary(lena_18mo_sym_int_ctc_daily_rate)
#ns

lena_18mo_sym_int_cvc_daily_rate <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win * cvc_daily_rate,
    data = lena_18mo_sym_df 
  )
summary(lena_18mo_sym_int_cvc_daily_rate)
#ns

lena_18mo_sym_int_numstress_awc <- 
  lm(
    itsea_symptoms_centered ~ 
      num_stress_total * awc_prop,
    data = lena_18mo_sym_df
    )
summary(lena_18mo_sym_int_numstress_awc)
#ns

lena_18mo_sym_int_numstress_preg_awc <- 
  lm(
    itsea_symptoms ~ 
      num_stress_preg * awc_prop,
    data = lena_18mo_sym_df)
summary(lena_18mo_sym_int_numstress_preg_awc)
#ns

lena_18mo_sym_int_sumsev_awc <- 
  lm(
    itsea_symptoms ~ 
      sum_sev * awc_prop,
    data = lena_18mo_sym_df
    )
summary(lena_18mo_sym_int_sumsev_awc)
#ns

lena_18mo_sym_int_maxsev_awc <- 
  lm(
    itsea_symptoms ~ 
      max_sev * awc_prop,
    data = lena_18mo_sym_df
    )
summary(lena_18mo_sym_int_maxsev_awc)
#ns

lena_18mo_sym_int_numstress_ctc <- 
  lm(
    itsea_symptoms_centered ~ 
      num_stress_total * ctc_prop,
    data = lena_18mo_sym_df
    )
summary(lena_18mo_sym_int_numstress_ctc)
#all variables are significant!

lena_18mo_sym_int_numstress_preg_ctc <- 
  lm(
    itsea_symptoms ~ 
      num_stress_preg * ctc_prop,
    data = lena_18mo_sym_df
    )
summary(lena_18mo_sym_int_numstress_preg_ctc)
#ns

lena_18mo_sym_int_sumsev_ctc <- 
  lm(
    itsea_symptoms ~ 
      sum_sev * ctc_prop,
    data = lena_18mo_sym_df
    )
summary(lena_18mo_sym_int_sumsev_ctc)
#all variables are significant

lena_18mo_sym_int_maxsev_ctc <- 
  lm(
    itsea_symptoms ~ 
      max_sev * ctc_prop,
    data = lena_18mo_sym_df
    )
summary(lena_18mo_sym_int_maxsev_ctc)
#ns
```
...
coefficient standard error: The coefficient Standard Error measures the average amount that the coefficient estimates vary from the actual average value of our response variable. We’d ideally want a lower number relative to its coefficients.
...
#Run main analyses (interactions) with crisys_neg_total
...
summary(lena_18mo_sym_awc_cent)
#
...
summary(lena_18mo_sym_awc)
#awc_prop estimate = -.3767, t = -1.343, p = .185
...
summary(lena_18mo_sym_ctc)
#ctc_prop estimate = -0.5743, t = -2.39, p = .02
...
lena_18mo_sym_cvc <- 
  lm(
    itsea_symptoms ~ 
      cvc_prop,
    data = lena_18mo_sym_df)
summary(lena_18mo_sym_cvc)
#cvc_prop estimate = -0.5256, t = -1.71, p = .093

lena_18mo_sym_awc_daily <- 
  lm(
    itsea_symptoms ~ 
      awc_daily_rate,
    data = lena_18mo_sym_df)
summary(lena_18mo_sym_awc_daily)
#awc_daily_rate estimate = -1.213e^-4, t = -2.39, p = .02

lena_18mo_sym_ctc_daily <- 
  lm(
    itsea_symptoms ~ 
      ctc_daily_rate,
    data = lena_18mo_sym_df)
summary(lena_18mo_sym_ctc_daily)
#ctc_daily_rate estimate = -.005569, t = -2.69, p = .009

lena_18mo_sym_cvc_daily <- 
  lm(
    itsea_symptoms ~ 
      cvc_daily_rate,
    data = lena_18mo_sym_df)
summary(lena_18mo_sym_cvc_daily)
...
#no main effect total num stressors
...
#run model with covs
```{r}
lena_18mo_sym_int_sex_cov <- 
  lm(itsea_symptoms_centered ~ 
       crisys_total_6mo_win * awc_prop_centered 
     + male, 
     data = lena_18mo_sym_df)
summary(lena_18mo_sym_int_sex_cov)
...
lena_18mo_sym_int_awc_daytype <-
  lm(itsea_symptoms_centered ~ 
       crisys_total_6mo_win * awc_prop 
     + day_type,
     data = lena_18mo_sym_df)
summary(lena_18mo_sym_int_awc_daytype)

lena_18mo_sym_int_ctc_covs <- 
  lm(itsea_symptoms_centered ~ 
     ...
     + NEG,
     data = lena_18mo_sym_df)
summary(lena_18mo_sym_int_ctc_covs)

lena_18mo_sym_int_ctc_daytype <-
  lm(itsea_symptoms_centered ~ 
       crisys_total_6mo_win * ctc_prop 
     + day_type,
     data = lena_18mo_sym_df)
summary(lena_18mo_sym_int_ctc_daytype)
...
```{r}
lena_18mo_sym_int_awc_daily <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win * awc_daily_rate,
    data = lena_18mo_sym_df 
                 )
summary(lena_18mo_sym_int_awc_daily)
#entire model sig (p = 0.028), but none of the individual predictors are

lena_18mo_sym_int_ctc_daily <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win * ctc_daily_rate,
    data = lena_18mo_sym_df 
                 )
summary(lena_18mo_sym_int_ctc_daily)
#entire model sig (p = 0.023), but none of the individual predictors are

lena_18mo_sym_int_cvc_daily <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win * cvc_daily_rate,
    data = lena_18mo_sym_df 
                 )
summary(lena_18mo_sym_int_cvc_daily)
#ns
...
summary(lena_18mo_sym_int_ctc)
#entire model sig (p = .0271), but none of individual predictors
```

#determine adjusted r squared for just interaction term
#run each predictor separately
```{r}
#amt of varianc explained just by crisys
lena_18mo_sym_just_crisys <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win,
    data = lena_18mo_sym_df 
                 )
summary(lena_18mo_sym_just_crisys)
#adjusted r squared: 0.0264; ns

#amt of variance explained just by awc_prop_centered
lena_18mo_sym_just_awc_prop <- 
  lm(
    itsea_symptoms_centered ~ 
     awc_prop_centered,
    data = lena_18mo_sym_df 
                 )
summary(lena_18mo_sym_just_awc_prop)
#adjusted r squared: 0.0126, ns

#full model w interaction adjusted r squared = .1482, so just interaction term explains:
int_adjust_r_squared = .1419 - .0264 - .0126
print(int_adjust_r_squared)
#variance explained = .1092
```
#test awc_daily_rate
```{r}
lena_18mo_sym_int_awc_rate <- 
  lm(
    itsea_symptoms ~ 
      crisys_total_6mo_win * awc_daily_rate,
    data = lena_18mo_sym_df, 
...
summary(lena_18mo_sym_int_awc_rate)
```
...
lena_18mo_sym_int_ctc_weekdays <- 
  lm(
    itsea_symptoms ~ 
      crisys_total_6mo_win * ctc_prop_centered,
    data = lena_18mo_sym_df_weekdays
  )
summary(lena_18mo_sym_int_ctc_weekdays)

lena_18mo_sym_ctc_weekdays <- 
  lm(
    itsea_symptoms ~ 
      ctc_prop_centered,
    data = lena_18mo_sym_df_weekdays
  )
summary(lena_18mo_sym_ctc_weekdays)
```
...
#Within just subset of ps using for this project
...
summary(lena_18mo_sym_int_awc)
```
#probe awc_prop x crisys_total interaction w simple slope analysis
```{r}
#create new variables: high and low awc_prop & ctc_prop
lena_18mo_sym_df <-
  lena_18mo_sym_df %>% 
  mutate(
    awc_prop_hi = scale(awc_prop, scale = F) - sd(awc_prop),
    awc_prop_low = scale(awc_prop, scale = F) + sd(awc_prop),
...
#run model with awc_prop_hi
lena_18mo_sym_int_awc_hi <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win * awc_prop_hi,
    data = lena_18mo_sym_df 
                 )

summary(lena_18mo_sym_int_awc_hi)
#when dependability is high, crisys variable beta is -.004198 and it is not significant
#so when dep is high, greater past 6 month stress predicts slightly lower sx

#run model with awc_prop_low
lena_18mo_sym_int_awc_low <- 
  lm(
    itsea_symptoms_centered ~ 
      crisys_total_6mo_win * awc_prop_low,
    data = lena_18mo_sym_df 
                 )

summary(lena_18mo_sym_int_awc_low)
#when dependability is low, crisys variable beta is .02966 and it is significant
#so when dep is low, greater past 6 month stress predicts greater symptoms

```
#probe ctc_prop x num_stress_total w simple slopes
```{r}
#run model everything centered again (just for kicks)
...
#olsrr diagnostics, standardized betas 
```{r}
##standardized betas
