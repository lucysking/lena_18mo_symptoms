...
write_csv(fp_final_wf, "~/Desktop/BABIES/lena_symptoms/data_final/free_play_wf_20191014.csv")
```

```{r}
fp_final_wf %>% 
  ggplot(aes(negmood_fin)) +
  geom_histogram() +
  theme_lena +
  labs(
    x = "Infant negative moood during play"
  )

ggsave("~/Desktop/BABIES/lena_symptoms/manuscript/negmood_fp.png")
```
