...
psych::alpha(itsea_alpha_total)

#externalizing subscales
itsea_alpha_externalizing <-
  q_18month_scored %>% 
  select(
    itsea_activity,
    itsea_agress
...
psych::alpha(itsea_alpha_externalizing)

#internalizing
itsea_alpha_internalizing <-
  q_18month_scored %>% 
  select(
    itsea_depp,
    itsea_gad
...
psych::alpha(itsea_alpha_internalizing)

#items within internalizing
itsea_alpha_int_items <-
  q_18month_scored %>% 
  select(
    itsea_a9, 
    itsea_a39, 
...
psych::alpha(itsea_alpha_int_items)

#items with externalizing
itsea_alpha_ext_items <-
  q_18month_scored %>% 
  select(
    itsea_a2, 
    itsea_a4, 
...
psych::alpha(itsea_alpha_ext_items)

#negemo
itsea_alpha_negemo_items <-
  q_18month_scored %>% 
  select(
    itsea_a21, 
    itsea_a23, 
...
psych::alpha(itsea_alpha_negemo_items)

#all items
itsea_alpha_all_items <-
  q_18month_scored %>% 
  select(
    itsea_a9, 
    itsea_a39, 
...
psych::alpha(itsea_alpha_all_items)
...
write_csv(q_18month_scored, "~/Desktop/lena_18mo_symptoms/Data/q_18month_scores_20190726.csv")
```
