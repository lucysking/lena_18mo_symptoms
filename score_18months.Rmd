...
## Fran file paths
q_18month_cs_file <- "~/Desktop/lena_18mo_symptoms/Data_Final/qs_18mo_cs_datecleaned_20190726.csv"
q_18month_long_file <- "~/Desktop/lena_18mo_symptoms/Data_Final/qs_18mo_long_datecleaned_20190726.csv"
demographics_file <- "~/Desktop/lena_18mo_symptoms/Data_Final/demographics_20190726.csv"
...
#calculate concern scores for lena_18mo_symptoms
...
#calculate concern counts for lena_18mo_sym 
itsea_concern %>% 
  count(activity_concern)
...
glimpse(q18month_symp)
```

# Distributions of itsea scores 

```{r}
identify_outliers_hist(x = itsea_competence, data = q18month_symp)
identify_outliers_hist(x = itsea_symptoms, data = q18month_symp)
identify_outliers_hist(x = itsea_f2_competence, data = q18month_symp)
identify_outliers_hist(x = itsea_f1_symptoms, data = q18month_symp)
```
...
q_18month_scored$asq_c1r = dplyr::recode(q_18month_scored$asq_c1, "1"=10, "2"=5, "3"=0)
q_18month_scored$asq_c2r = dplyr::recode(q_18month_scored$asq_c2, "1"=10, "2"=5, "3"=0)
q_18month_scored$asq_c3r = dplyr::recode(q_18month_scored$asq_c3, "1"=10, "2"=5, "3"=0)
q_18month_scored$asq_c4r = dplyr::recode(q_18month_scored$asq_c4, "1"=10, "2"=5, "3"=0)
q_18month_scored$asq_c5r = dplyr::recode(q_18month_scored$asq_c5, "1"=10, "2"=5, "3"=0)
q_18month_scored$asq_c6r = dplyr::recode(q_18month_scored$asq_c6, "1"=10, "2"=5, "3"=0)
...
q_18month_scored$mbcdi_101 = dplyr::recode(q_18month_scored$mbcdi_101, "1"=0, "2"=1, "3"=2)
...
# write_csv(q18month_symp, "~/Desktop/BABIES/lena_symptoms/fran_box_data/q_18month_scores_20190519.csv")

write_csv(q18month_symp, "~/Desktop/lena_18mo_symptoms/Data_Final/q_18month_scores_20190726.csv")
```
...
write_csv(q18month_scores, "~/Desktop/lena_18mo_symptoms/Data/q_18month_scored_20190510.csv") #this one just has the calculated scores

write_csv(q_18month_scored, "~/Desktop/lena_18mo_symptoms/Data/q_18month_20190510.csv") #this one has all the original variables as well as the scores
