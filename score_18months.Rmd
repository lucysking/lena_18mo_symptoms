...
q_18month_cs_file <- "~/Desktop/lena_18mo_symptoms/Data/qs_18mo_cs_datecleaned_20190413.csv"
q_18month_long_file <- "~/Desktop/lena_18mo_symptoms/Data/qs_18mo_long_datecleaned_20190413.csv"
  ...
  left_join(
    q_18month_scored %>% 
      select(
        ...
        itsea_symptoms_mean,
        itsea_symptoms_sum,
        itsea_competence_mean,
        itsea_competence_sum,
        male
      ), 
    by = "ID") %>% 
    left_join(
...
write_csv(q18month_symp, "~/Desktop/lena_18mo_symptoms/Data/q_18month_scores_20190413.csv")
```
...
write_csv(q18month_scores, "~/Desktop/lena_18mo_symptoms/Data/q_18month_scored_20190413.csv") #this one just has the calculated scores

write_csv(q_18month_scored, "~/Desktop/lena_18mo_symptoms/Data/q_18month_20190413.csv") #this one has all the original variables as well as the scores
...
```{r}
#to get around error in itsea scoring to get baby_age_18month date for lena symptoms project
q_18month <-
  q_18month %>% 
  mutate(
    survey_date = parse_date_time(survey_date, orders = c("ymd", "mdy")),
...
write_csv(q_18month, "~/Desktop/lena_18mo_symptoms/Data/q_18month_ages.csv")
```
