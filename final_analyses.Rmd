...
### OLS regression including fp sensitivity and CT prop
```{r}
sym_fp_ctc_prop <- 
  lm(
    itsea_symptoms ~ 
...
summary(sym_fp_ctc_prop)

std_beta(sym_fp_ctc_prop)

r_chg_fp_ctcprop <- summary(sym_fp_ctc_prop)$adj.r.squared - r.squared_base

r_chg_fp_ctcprop

confint(sym_fp_ctc_prop)
...
```{r}
write_csv(d0_d1, "~/Desktop/BABIES/lena_symptoms/data_final/king_caregivinginput_itsea_20191105.csv")
```
