...
#lena_5min_file_1 <- "~/Desktop/BABIES/data/lena_data/Exports_Cleaned/LENAExport_5Minute_20181220_cleaned.csv"
#lena_5min_file_2 <- "~/Desktop/BABIES/data/lena_data/Exports_Cleaned/LENAExport_5Minute_new_20190204.csv"
...
#lena_5min_files <- "~/Desktop/BABIES/data/lena_data/Exports_Cleaned/individual_5min_format_cleaned"
lena_5min_files <- "~/Desktop/lena_18mo_symptoms/Data/individual_5min_lsk_format_cleaned"

lena_followup_long_file <- "~/Desktop/lena_18mo_symptoms/Data/lena_followup_long_datecleaned_20190216.csv"
lena_followup_cs_file <- "~/Desktop/lena_18mo_symptoms/Data/lena_followup_cs_datecleaned_20190216.csv"
...
lena_5min_cl <- 
  ...
  mutate(
    ...
    awc_depend_prop = (awc_depend_sum) / ((duration * 60) / 5), #proportion of 5 minute segments with AWC
    ctc_depend_prop = (ctc_depend_sum) / ((duration * 60) / 5), #proportion of 5 minute segments with CTC 
    cvc_depend_prop = (cvc_depend_sum) / ((duration * 60) / 5)
  ) %>% 
  filter(
    (age >= 5 & age <= 8),
    duration >= 8
...
lena_5min_cl_wf %>% 
  summarise_at(
    vars(awc_depend_prop_D1, ctc_depend_prop_D1),
...
write_csv(lena_followup_and_data, "~/Desktop/lena_18mo_symptoms/Data/lena_followup_and_data_20190202.csv")
