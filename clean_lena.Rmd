...
lena_5min_cl <- 
  ...
  summarise(
    ...
    #awc_rate = awc_actual/duration
    #ctc_rate = ctc_actual/duration
    #cvw_rate
...
#Conclusion: 54 with weekend recording, so need to covary for day type

#duration in crowd vs. metrics of interest
