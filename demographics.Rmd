...
demo_baby_long_file <- "~/Desktop/lena_18mo_symptoms/Data/demo_long_nb_20190131.csv"
...
dob_long_file <- "~/Desktop/lena_18mo_symptoms/Data/dob_long_20190131.csv"
...
visit_date_long_6mo_file <- "~/Desktop/lena_18mo_symptoms/Data/visit_date_long_6mo_20190131.csv"
...
visit_dates_long_t1t2_file <- "~/Desktop/lena_18mo_symptoms/Data/long_t1t2_dates_20190131.csv"
...
dates <-
  ...
  mutate(
    mom_dob = parse_date(mom_dob, format = "%Y-%m-%d"),
    baby_dob = parse_date(baby_dob, format = "%Y-%m-%d"),
    visit_date_6mo = parse_date(visit_date_6mo, format = "%Y-%m-%d"),
    date_preg = parse_date(date_preg, format = "%Y-%m-%d"),
    baby_due_date = parse_date(baby_due_date, format = "%Y-%m-%d"),
    date_newborn = parse_date(date_newborn, format = "%Y-%m-%d"),
...
write_csv(demo, "~/Desktop/lena_18mo_symptoms/Data/demographics_20190131.csv")
